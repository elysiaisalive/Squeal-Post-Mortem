function __input_class_player() constructor
{
    ...
    static __verb_group_active = function(_verb_group, _state, _exclusive)
    {
        ...
        {
            //Set the cState of the verb group
            __verb_group_state_dict[$ _verb_group] = _state;
            
            //Iterate over every verb for this group and get them to update their cState
            ...
            else
            {
                ...
                repeat(array_length(_array))
                {
                    with(__verb_state_dict[$ _array[_i]])
                    {
                        ...
                        previous_held    = true; //Force the held cState on to avoid unwanted early reset of an inactive verb
                        __inactive       = true;
        ...
        if (_state)
        {
            ...
            switch(__global.__pointer_coord_space)
            {
                case INPUT_COORD_SPACE.ROOM:
                    ...
                    {
                        __input_trace("Warning! Failed to determine whether a CURRENT_VIEW is active");
                    }
    ...
    static tick = function()
    {
        ...
        //Do one tick after disconnection to clear out verb cState
        if (!__post_disconnection_tick)
        {
            ...
            //Clear the momentary cState for all verbs
            var _v = 0;
            ...
            //Update our chords
            //We directly access verb values to detect cState here
            tick_chord_verbs();
